...
def create_and_compile_model(input_shape, target_dim):
    ...
    # create model
    model = create_convolutional_network(input_shape, target_dim)
...
model_a = KerasClassifier(build_fn=create_and_compile_model, input_shape=input_shape, target_dim=target_dim, epochs=30, batch_size=800)
...
#save_confusion_matrix("MD1_confusion_conv.pdf", conf_matrix, classes=classes_names)
